...
<div class="contentContainer2">
	<h2 class="head_2"><?php echo MY_NOTIFICATIONS_TITLE; ?></h2>

	<div class="contentText2">
		<?php echo MY_NOTIFICATIONS_DESCRIPTION; ?>
	</div>
<br />
	<h2 class="head_2"><?php echo GLOBAL_NOTIFICATIONS_TITLE; ?></h2>
...
?>
	...
	<h2 class="head_2"><?php echo NOTIFICATIONS_TITLE; ?></h2>
...
<br />
	<div class="buttonSet">
		<span class="buttonAction" style="margin-top:-10px; margin-bottom:25px;"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?></span>
