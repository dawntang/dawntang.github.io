...
<h1 class="headingtellafriend"><?php echo sprintf(HEADING_TITLE, $product_info['products_name']); ?></h1>
...
<div class="contentContainer">
	<div>
		...
		<div style="overflow:hidden;" class="contentText">
    
	
			<div class="fieldKey"><?php echo FORM_FIELD_CUSTOMER_NAME; ?></div>
			<div class="fieldValue"><?php echo tep_draw_input_field('from_name'); ?></div>
	
		
			<div class="fieldKey"><?php echo FORM_FIELD_CUSTOMER_EMAIL; ?></div>
			<div class="fieldValue"><?php echo tep_draw_input_field('from_email_address'); ?></div>
			...
			<div class="fieldKey"><?php echo FORM_FIELD_FRIEND_NAME; ?></div>
			<div class="fieldValue"><?php echo tep_draw_input_field('to_name') . '&nbsp;<span class="inputRequirement">' . ENTRY_FIRST_NAME_TEXT . '</span>'; ?></div>
		
	
			<div class="fieldKey"><?php echo FORM_FIELD_FRIEND_EMAIL; ?></div>
			<div class="fieldValue"><?php echo tep_draw_input_field('to_email_address') . '&nbsp;<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>'; ?></div>
			...
			<div class="fieldKey"><?php echo FORM_FIELD_YOUR_MESSAGE; ?></div>
			<div class="fieldValue"><?php echo tep_draw_textarea_field('message', 'soft', 50, 8); ?></div>
