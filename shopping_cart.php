...
<h1 class="headingshoppingcart" style="margin-bottom:9px;"><?php echo HEADING_TITLE; ?></h1>
...
<div class="contentContainer2">
	...
	<h2 class="head_1"><?php echo TABLE_HEADING_PRODUCTS; ?></h2>
...
<?php
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $products_name = '<div>' .
                       '  <div>' .
                       '    <div id="shopping-cart-image" ><br /><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products[$i]['id']) . '">' . tep_image(DIR_WS_IMAGES . $products[$i]['image'], $products[$i]['name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'style=" "' ) . '</a></div>' .
                       '    <div><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products[$i]['id']) . '"><strong>' . $products[$i]['name'] . '</strong></a><br />';
...
?>
	...
	<p align="right" style="clear: both; padding: 15px 25px 0 0;"><?php echo TEXT_ALTERNATIVE_CHECKOUT_METHODS; ?></p>
