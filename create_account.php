...
<div id="createaccountContainer" class="contentContainer2">
	<div>
...
<br />
		...
		<h2 class="head_2"><?php echo CATEGORY_PERSONAL; ?></h2>
	</div>
...
?>
        ...
        <div class="fieldValue"><?php echo tep_draw_input_field('email_address') . '&nbsp;' . (tep_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?></div>
...
?>
	...
	<h2 class="head_2" style="clear:both;"><?php echo CATEGORY_COMPANY; ?></h2> 
...
?>
	...
	<h2 class="head_2" style="clear:both;"><?php echo CATEGORY_ADDRESS; ?></h2> 
...
?>
 ...
 <br />
	<h2 class="head_2" style="clear:both"><?php echo CATEGORY_CONTACT; ?></h2> 

	<div class="contentText2">
		<div style="overflow:hidden;">
		
			<div class="fieldKey"><?php echo ENTRY_TELEPHONE_NUMBER; ?></div>
			<div class="fieldValue"><?php echo tep_draw_input_field('telephone') . '&nbsp;' . (tep_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_TELEPHONE_NUMBER_TEXT . '</span>': ''); ?></div>
     
      
			<div class="fieldKey"><?php echo ENTRY_FAX_NUMBER; ?></div>
			<div class="fieldValue"><?php echo tep_draw_input_field('fax') . '&nbsp;' . (tep_not_null(ENTRY_FAX_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_FAX_NUMBER_TEXT . '</span>': ''); ?></div>
 ...
 <br />
	<h2 class="head_2" style="clear:both"><?php echo CATEGORY_PASSWORD; ?></h2> 

	<div class="contentText2">
		<div style="overflow:hidden;">
     
			<div class="fieldKey"><?php echo ENTRY_PASSWORD; ?></div>
			<div class="fieldValue"><?php echo tep_draw_password_field('password') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_TEXT . '</span>': ''); ?></div>
    
     
			<div class="fieldKey"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></div>
			<div class="fieldValue"><?php echo tep_draw_password_field('confirmation') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_CONFIRMATION_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_CONFIRMATION_TEXT . '</span>': ''); ?></div>
