...
<div class="breadcrumb"><?php echo '&nbsp;&nbsp;' . $breadcrumb->trail('&raquo;'); ?></div>
	<div>
		<h1 class="headingproductinfo"><?php echo $products_name, '<div style="text-align: right; margin-top: -22px; padding-bottom: 37px;">' . $products_price . '</div>';?></h1>
	</div>
...
$('#piGal ul').bxGallery({
  maxwidth: 300,
  maxheight: 200,
  thumbwidth: <?php echo (($pi_counter > 1) ? '70' : '0'); ?>,
  thumbcontainer: 255,
...
?>
    ...
    <div id="gallery2" style="float: left;">
