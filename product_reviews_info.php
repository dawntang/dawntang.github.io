...
<div id="product-reviews-info-container" class="contentText">
	...
	<div id="product-reviews-info-wrapper">
		...
		<div id="product-reviews-info-text"><?php echo tep_break_string(nl2br(tep_output_string_protected($review['reviews_text'])), 60, '-<br />') . '<br /><br />' . sprintf(TEXT_REVIEW_RATING, tep_image(DIR_WS_IMAGES . 'stars_' . $review['reviews_rating'] . '.png', sprintf(TEXT_OF_5_STARS, $review['reviews_rating'])), sprintf(TEXT_OF_5_STARS, $review['reviews_rating'])); ?></div>
	</div>
