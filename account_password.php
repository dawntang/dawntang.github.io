...
<div class="contentContainer2">
	<div>
		<h2 class="head_2"><?php echo MY_PASSWORD_TITLE; ?></h2>
	</div>

	<div id="account-password-container" class="contentText2">
...
<br />
	<div class="buttonSet">
		<span class="buttonAction" style="margin-top:-10px; margin-bottom:15px; "><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?></span>
	</div>
</div>
