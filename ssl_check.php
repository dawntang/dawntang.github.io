...
<h1 class="headingsslcheck"><?php echo HEADING_TITLE; ?></h1>

<div id="sslCheckContainer" class="contentContainer">
	<div class="contentText">
		<div id="sslCheckBoxHeadingContainer" class="ui-widget infoBoxContainer">
			<div class="headerCheckoutAddress infoBoxHeading"><?php echo BOX_INFORMATION_HEADING; ?></div>

			<div id="sslCheckBoxContentContainer" class="contentCheckoutAddress infoBoxContents">
