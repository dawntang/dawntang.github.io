...
<h1 class="headingcheckoutpaymentaddress"><?php echo HEADING_TITLE; ?></h1>
...
?>
	...
	<h2><?php echo TABLE_HEADING_PAYMENT_ADDRESS; ?></h2><hr>

	<div class="contentText">
		<div class="ui-widget infoBoxContainer" style="float: left; padding-right:5px;">
			<div class="headerCheckoutAddress infoBoxHeading"><?php echo TITLE_PAYMENT_ADDRESS; ?></div>
...
?>
	...
	<h2><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></h2><hr>
...
?>
			...
			<span><strong><?php echo $addresses['firstname'] . ' ' . $addresses['lastname']; ?></strong></span>
			<span style="float:right; padding-top:2px;"><?php echo tep_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $billto)); ?></span>
		</div>
		<div>
			<div style="padding-left: 15px;"><?php echo tep_address_format($format_id, $addresses, true, ' ', ', '); ?></div>
		</div>
<br />
<?php
        $radio_buttons++;
...
<div id="border-bottom" style="clear:both;"></div><br />
	<h2><?php echo TABLE_HEADING_NEW_PAYMENT_ADDRESS; ?></h2><hr>
...
?>
	...
	<div id="checkout-payment-address-container" class="contentText">
		<div id="checkout-payment-address-wrapper">
			<div class="checkoutBarFrom"><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '" >' . CHECKOUT_BAR_DELIVERY . '</a>'; ?></div>
			<div class="checkoutBarCurrent"><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '" >' . CHECKOUT_BAR_PAYMENT . '</a>'; ?></div>
