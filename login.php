...
<div style="overflow:hidden;" class="contentContainer2">
	...
	<div style="width:100%; overflow:hidden;">
		...
		<div class="location4">
          ...
          <div style="float:right; clear:both; margin-right:12px; margin-top:75px;">  <?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL')); ?></div>
		</div>
	</div>
		...
		<div style="width:50%; overflow:hidden; float:right;">
            ...
            <div class="location4">
            <h2 id="headingreturningcustomer"><?php echo HEADING_RETURNING_CUSTOMER; ?></h2>
			...
			<br />
			<div style="float:right; clear:both; margin-right:12px;margin-top:-14px;"><?php echo tep_draw_button(IMAGE_BUTTON_LOGIN, 'key', null, 'primary'); ?></div>
		</div></div>
	</div>
</div>
 </form>
